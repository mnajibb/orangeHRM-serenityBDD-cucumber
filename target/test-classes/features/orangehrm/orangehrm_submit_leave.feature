Feature: Orange HRM Submit Leave
  ...
  # please make sure that the leave balance is on 23 to make sure test code runs correctly
  # to be honest, i can create some pre-requisite codes to make sure the balance is always on 23 before run the test by using serenity bdd cucumber background tag, but due to limited time constraints i can not make it :)
